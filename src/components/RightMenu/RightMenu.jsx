...
const RightMenu = (props) => {
    ...
    // }else{
        const {title,id,note,time} = props.task;
    // }
    const {mode,setTitle,setNote,new_title,new_note,addTaskToList} = props;
    ...
    return (
        ...
        <div className="right-panel p-2" style={{backgroundColor:'#FAFAF8',width:'100%'}}>
            ...
            <button className="p-2 my-3 btn btn-success"onClick={addTaskToList}>Save</button>
        </div>
